...
module {
  func.func @main(%arg0: tensor<8xf32>, %arg1: tensor<8xf32>, %arg2: tensor<i64>, %arg3: tensor<1x1x16x16xf32>) -> tensor<1x8x16x16xf32> {
    ...
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%expanded : tensor<8x1x1xf32>) {
    ^bb0(%in: f32):
      %3 = arith.truncf %cst_3 : f64 to f32
      %4 = arith.addf %in, %3 : f32
      %5 = math.sqrt %4 : f32
      %6 = arith.cmpf one, %5, %cst : f32
      cf.assert %6, "unimplemented: tensor with zero element"
      linalg.yield
    }
    %expanded_6 = tensor.expand_shape %arg0 [[0, 1, 2]] output_shape [8, 1, 1] : tensor<8xf32> into tensor<8x1x1xf32>
    linalg.generic {indexing_maps = [#map1, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1, %expanded : tensor<1x8x16x16xf32>, tensor<8x1x1xf32>) {
    ^bb0(%in: f32, %in_9: f32):
      %3 = arith.truncf %cst_3 : f64 to f32
      %4 = arith.addf %in_9, %3 : f32
      %5 = math.sqrt %4 : f32
      %6 = arith.cmpf one, %5, %cst : f32
      cf.assert %6, "unimplemented: tensor with zero element"
      linalg.yield
    ...
    %2 = linalg.generic {indexing_maps = [#map1, #map2, #map2, #map2, #map2, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1, %expanded_6, %expanded, %expanded_7, %expanded_8 : tensor<1x8x16x16xf32>, tensor<8x1x1xf32>, tensor<8x1x1xf32>, tensor<8x1x1xf32>, tensor<8x1x1xf32>) outs(%0 : tensor<1x8x16x16xf32>) {
    ^bb0(%in: f32, %in_9: f32, %in_10: f32, %in_11: f32, %in_12: f32, %out: f32):
      %3 = arith.truncf %cst_3 : f64 to f32
      %4 = arith.addf %in_10, %3 : f32
      %5 = math.sqrt %4 : f32
      %6 = arith.cmpf one, %5, %cst : f32
      cf.assert %6, "unimplemented: tensor with zero element"
      %7 = arith.divf %cst_0, %5 : f32
      %8 = arith.subf %in, %in_9 : f32
      %9 = arith.mulf %8, %7 : f32
      %10 = arith.mulf %9, %in_11 : f32
      %11 = arith.addf %10, %in_12 : f32
