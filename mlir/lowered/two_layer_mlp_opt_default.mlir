...
module {
  func.func @main(%arg0: tensor<1x4xf32>) -> tensor<1x2xf32> {
    ...
    %5 = tensor.empty() : tensor<8x2xf32>
    %transposed_4 = linalg.transpose ins(%cst_1 : tensor<2x8xf32>) outs(%5 : tensor<8x2xf32>) permutation = [1, 0] 
    %6 = tensor.empty() : tensor<1x2xf32>
    %7 = linalg.fill ins(%cst : f32) outs(%6 : tensor<1x2xf32>) -> tensor<1x2xf32>
    %8 = linalg.matmul ins(%4, %transposed_4 : tensor<1x8xf32>, tensor<8x2xf32>) outs(%7 : tensor<1x2xf32>) -> tensor<1x2xf32>
    %9 = linalg.generic {indexing_maps = [#map, #map1, #map], iterator_types = ["parallel", "parallel"]} ins(%8, %cst_0 : tensor<1x2xf32>, tensor<2xf32>) outs(%6 : tensor<1x2xf32>) {
    ^bb0(%in: f32, %in_5: f32, %out: f32):
      %10 = arith.addf %in, %in_5 : f32
      linalg.yield %10 : f32
    } -> tensor<1x2xf32>
    return %9 : tensor<1x2xf32>
  }
}
